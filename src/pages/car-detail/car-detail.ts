...
export class CarDetailPage {
  ...
  public getCarColor() {
    ...
    //   });
      ...
      this.http.post(link, send_data, {})
      .then(data => {
        this.data_table_color = JSON.parse(data.data["_body"]);
  ...
  public load_data() {
    ...
    //   });
      ...
      this.http.post(link, send_data, {})
      .then(data => {
        this.data_table_car = JSON.parse(data.data["_body"]);
  ...
  public getProvince() {
    ...
    //   });
      this.http.post(link, send_data, {})
      .then(data => {
        this.data_table_province = JSON.parse(data.data["_body"]);
        console.log(data.status);
        console.log(data.data); // data received by server
        console.log(data.headers);
  ...
  public getCarBrand() {
    ...
    //   });
      ...
      this.http.post(link, send_data, {})
      .then(data => {
        this.data_table_brand = JSON.parse(data.data["_body"]);
        console.log(data.status);
        console.log(data.data); // data received by server
        console.log(data.headers);
  ...
  public getCarBrandYear() {
    ...
    //   });
      ...
      this.http.post(link, send_data, {})
      .then(data => {
        this.data_table_brand_year = JSON.parse(data.data["_body"]);
        console.log(data.status);
        console.log(data.data); // data received by server
        console.log(data.headers);
  ...
  public getCarModel() {
    ...
    //   });
      ...
      this.http.post(link, send_data, {})
      .then(data => {
        this.data_table_model = JSON.parse(data.data["_body"]);
        console.log(data.status);
        console.log(data.data); // data received by server
        console.log(data.headers);
