...
export class NotificationPage {
  ...
  public user_id;
  public countBadge = 0;
  constructor(public platform: Platform, public navCtrl: NavController, public modalCtrl: ModalController, public server: Server, public http: HTTP, public storage: Storage, public alertCtrl: AlertController) {
  ...
  public getNotification() {
    ...
    this.http.post(link, send_data, {})
    .then(data => {
      this.data_table_notification = JSON.parse(data.data["_body"]);
      this.countBadges();
