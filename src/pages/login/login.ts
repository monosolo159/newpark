...
export class LoginPage {
  ...
  constructor(public _OneSignal: OneSignal, public navCtrl: NavController, public navParams: NavParams, public modalCtrl: ModalController, public loadingCtrl: LoadingController, public http: HTTP, public alertCtrl: AlertController, public storage: Storage, public server: Server) {
